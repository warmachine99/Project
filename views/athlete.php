...
$athletes = selectAllAthletes_controller();
?>
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="athlete.php">Athletes</a>
          </li>
          <li class="nav-item">
  ...
  <header class="py-3 mb-4 border-bottom header-dark bg-dark">
    <div class="container d-flex flex-wrap justify-content-center">
      <a href="athlete.php" class="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto text-light text-decoration-none">
        <span class="fs-1">Athletes</span>
      </a>
    </div>
  </header>
      ...
      ?>
        ...
        <div class="col order-1" style="margin: 15px;">
          <div class="card" style="width: 18rem;">
            <img src="../Images/<?= $athlete['person_img'] ?>" class="card-img-top" alt="athlete">
            <div class="card-body">
              <p class="card-text"><?= $athlete['fname'] ?> <?= $athlete['lname'] ?></p>

              Country : <?= $athlete['country'] ?><br>
              Year of Birth : <?= $athlete['DOB'] ?> <br>
              Sporting Event : <?= $athlete['event_type'] ?> <br>
              Doping : <?= $athlete['doping'] ?> <br>
