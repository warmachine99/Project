  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light flex-column mt-3">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="admin.php">Manage Atheletes</a>
          </li>
          <li class="nav-item">
      ...
      <form class="row g-3" action="../actions/adminAction.php" method="POST">
        ...
        <div class="row">
          <div class="col-md-10">
            ...
            <input type="text" class="form-control" id="athleteID" name="athleteID">
          </div>
          <div class="col-md-10">
        ...
        <div class="col-md-10">
          <label for="sport" class="form-label"> Sporting Event</label>
        ...
        <div class="col-md-10">
          <label for="doping" class="form-label">Doping</label>
          <select id="doping" class="form-select" name="doping">
        ...
        <div class="col-md-10">
          <label for="imgname" class="form-label">Profile image</label>
          <input type="text" class="form-control" id="imgname" name="imgname">
        </div>
        <div class="d-grip gap-1 d-md-flex justify-content-md-end ">
          <button type="submit" class="btn btn-primary" name="submitAthlete">Add new athlete</button>
        </div>
    </div>
    </label>
  </div>
